...
Since my Supabase project was new, when it got to "run the SQL from `database_migration.sql`, I just copy-pasted the contents in that file and into the editor.

Settings -> Configuration -> Authentication -> Auth settings -> User Signups
