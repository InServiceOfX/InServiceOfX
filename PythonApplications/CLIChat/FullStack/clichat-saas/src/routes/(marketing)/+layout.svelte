  ...
  >
    <nav>
      ...
      <a
        ...
        href="https://github.com/InServiceOfX/InServiceOfX/tree/master/PythonApplications/CLIChat">Github (MIT License)</a
      >
    </nav>
    <aside>
      <span class="footer-title opacity-80">Company</span>
      <a class="max-w-[260px]" href="https://github.com/InServiceOfX">
