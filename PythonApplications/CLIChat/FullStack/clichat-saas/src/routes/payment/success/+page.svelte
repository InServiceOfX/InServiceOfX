  ...
  <div class="container mx-auto max-w-6xl text-center">
    ...
    <div>
      ...
      >
        ...
        {@html celebrate.svgContent}
      </svg>
    </div>

    <h1 class="mb-4 text-3xl font-bold">Thank You For Your Purchase!</h1>
    
    {#if data.isGuest}
      <p class="mb-5 text-lg">Welcome {data.customerName}!</p>
      <p class="mb-5">Is your email address {data.customerEmail} correct?</p>
    {/if}
    
    <p class="mb-5 text-lg">Your download will begin shortly...</p>
    ...
    {#if data.isGuest}
      <div class="mt-8 p-4 bg-blue-50 rounded-lg">
        <p class="text-sm text-blue-800">
          Want to stay in touch and receive news of updates?
          <a href="/register" class="underline font-medium">Create an account or login</a>
        </p>
      </div>
    {/if}
    <div class="mt-8">
