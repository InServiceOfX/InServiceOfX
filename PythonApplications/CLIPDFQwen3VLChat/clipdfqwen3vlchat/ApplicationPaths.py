# Keep imports minimal: this module runs *before* sys.path is set up, so it
# must not depend on any in-house library.
...
class ApplicationPaths:
    ...
    def create(
        ...
        # PythonApplications/CLIPDFQwen3VLChat/Executables/main_*.py -> parents[1]
        # is the application dir; parents[3] is the InServiceOfX repo root.
        ...
        def configuration_file_paths_from_base(
            ...
            return {
                "qwen3vl_configuration": (
                    base / "Configurations" / "qwen3vl_configuration.yml"
                ),
                "pdf_chat_configuration": (
                    base / "Configurations" / "pdf_chat_configuration.yml"
                ),
            }
        ...
        if configpath is not None:
            ...
            config_dir = Path.home() / ".config" / "clipdfqwen3vlchat"
            configuration_file_paths = configuration_file_paths_from_base(
                config_dir
            )
