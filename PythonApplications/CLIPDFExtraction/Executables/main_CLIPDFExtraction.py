...
Or specify an explicit configuration directory:
    ...
    python Executables/main_CLIPDFExtraction.py --configpath /some/dir

The directory must contain:
    Configurations/mineru_configuration.yml
...
from clipdfextraction import ApplicationPaths


def main_CLIPDFExtraction():
    ...
    from clipdfextraction.CLIPDFExtraction import CLIPDFExtraction

    cli = CLIPDFExtraction(application_paths)
    cli.run()


if __name__ == "__main__":
    main_CLIPDFExtraction()
