...
class ApplicationPaths:
    ...
    def create(
        ...
        # PythonApplications/CLIPDFExtraction/Executables/main_*.py -> parents[1]
        ...
        def configuration_file_paths_from_base(
            ...
            return {
                "mineru_configuration": (
                    base / "Configurations" / "mineru_configuration.yml"
                ),
                "pdf_extraction_configuration": (
                    base
                    / "Configurations"
                    / "pdf_extraction_configuration.yml"
                ),
            }
        ...
        if configpath is not None:
            ...
            config_dir = Path.home() / ".config" / "clipdfextraction"
            configuration_file_paths = configuration_file_paths_from_base(
                config_dir
            )
