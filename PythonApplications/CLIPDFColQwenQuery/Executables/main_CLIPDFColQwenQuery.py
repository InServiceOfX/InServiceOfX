...
The directory must contain:
    ...
    Configurations/pdf_query_configuration.yml
"""
...
from clipdfcolqwenquery import ApplicationPaths


def main_CLIPDFColQwenQuery():
    ...
    from clipdfcolqwenquery.CLIPDFColQwenQuery import CLIPDFColQwenQuery

    cli = CLIPDFColQwenQuery(application_paths)
    cli.run()


if __name__ == "__main__":
    main_CLIPDFColQwenQuery()
