...
python main_CLITextToSpeech.py
or
python main_CLITextToSpeech.py --dev
or
python main_CLITextToSpeech.py --configpath /path/to/app
where you run it from the CLITextToSpeech/Executables subdirectory where this file
is stored.
"""
...
from clitexttospeech.ApplicationPaths import ApplicationPaths

def main_CLITextToSpeech():
