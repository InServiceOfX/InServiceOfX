...
docker run -v /home/propdev/Prop/InServiceOfX:/InServiceOfX --gpus all -it --rm nvcr.io/nvidia/pytorch:23.08-py3
...
docker run -v /home/propdev/Prop/InServiceOfX:/InServiceOfX --gpus all -e NVIDIA_DISABLE_REQUIRE=1 -it -p 8888:8888 --rm --ipc=host --ulimit memlock=-1 --ulimit stack=67108864 nvcr.io/nvidia/pytorch:23.08-py3
