...
def main():
    ...
    try:
        configuration = ReadBuildConfigurationForMinimalStack().read_build_configuration(
    ...
    dockerfile_transformers = script_dir / "Dockerfile.transformers"
    ...
    BuildDockerImageNoArguments().build_docker_image(
