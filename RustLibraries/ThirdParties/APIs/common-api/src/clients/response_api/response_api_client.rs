...
mod tests {
    ...
    #[test]
    fn test_responses_api_client_build_curl_command() {
    ...
    #[test]
    fn test_responses_api_client_build_curl_command_with_xai_url() {
    ...
    fn test_trait_methods_work_for_both_clients() {
        ...
        let mut xai_client = ResponsesAPIClient::new(
            "dummy-xai-key".to_string(),
            "https://api.x.ai/v1/responses",
            Some(3600),
            None,
